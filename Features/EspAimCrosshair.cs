...
namespace Nex.Features
{
    ...
    public static class EspAimCrosshair
    {
        ...
        public static Vector3 GetPositionScreen(Graphics graphics)
        {
            ...
            var punchX = ((double)player.AimPunchAngle.X * Offsets.Offsets.weapon_recoil_scale).DegreeToRadian();
            var punchY = ((double)player.AimPunchAngle.Y * Offsets.Offsets.weapon_recoil_scale).DegreeToRadian();
